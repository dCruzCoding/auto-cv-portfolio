...
\begin{itemize}[leftmargin=0cm, label={}]
        ...
        \vspace{0.3cm}
        \item 
        \textbf{\large Investigador Predoctoral} \hfill \textbf{2018 - 2021} \\
        \textcolor{primary}{\textit{Universidad Complutense}} \ \textbullet \ \textit{Madrid, España} \\
        \vspace{0.05cm}
        Diseño experimental y análisis estadístico avanzado (SPSS, R) en psicología cognitiva.
        \vspace{0.3cm}
        \item 
